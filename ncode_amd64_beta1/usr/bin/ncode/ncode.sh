...
datainicial=`date +%s`
zenity --password --title="Ncode UPDATE" | sudo -S wget -O /tmp/ncode_amd64_beta1.deb https://github.com/ncode-dev/ncode/raw/main/ncode_amd64_beta1.deb &&
sudo gdebi --non-interactive /tmp/ncode_amd64_beta1.deb
echo "----------------------------------------------------------------" ; sleep 1
